...
-- Dumping structure for table uas_dev.uas_admin
...
-- Dumping structure for table uas_dev.uas_admin_flags
CREATE TABLE IF NOT EXISTS `uas_admin_flags` (
  ...
  `flags` int(10) unsigned DEFAULT NULL COMMENT 'Flags (bit-summ); If set - overrides the value from uas_admin',
  `immunity` int(10) unsigned DEFAULT NULL COMMENT 'Immunity; If set - overrides the value from uas_admin',
  `deleted_at` int(10) unsigned DEFAULT NULL COMMENT 'Deleted datetime (represented in UNIX TIMESTAMP); if null - administrator is not deleted',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Assigned administrator custom permissions to servers';

-- Data exporting was unselected.

-- Dumping structure for table uas_dev.uas_admin_group
CREATE TABLE IF NOT EXISTS `uas_admin_group` (
  ...
  `deleted_at` int(10) unsigned DEFAULT NULL COMMENT 'When admin group should be removed',
...
-- Dumping structure for table uas_dev.uas_group
...
-- Dumping structure for table uas_dev.uas_group_immunity
...
-- Dumping structure for table uas_dev.uas_group_override
...
-- Dumping structure for table uas_dev.uas_override
...
-- Dumping structure for table uas_dev.uas_override_server
...
-- Dumping structure for table uas_dev.uas_server
